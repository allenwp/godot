...
void main() {
	...
	// higher quality contrast adjustment.
	color.rgb = mix(vec3(0.5), color.rgb, contrast);

	// Apply saturation:
	// By applying the saturation adjustment with even weights the preceived
	// brightness of saturated colors is affected, but this maintains
